...
### Step 2: รัน Django management command หรือ shell
ใช้ Bash:
```bash
cd "e:/Project Peyo Peyo/Agent Skill Claude"
./venv/Scripts/python.exe manage.py shell << 'EOF'
