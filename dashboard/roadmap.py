...
CURRENT = {
    ...
    'note': '**27 ส.ค. 2569 เจ้าของสั่งยกเครื่องเรื่องการหาเงิน — เปิดเฟส 9** '
            ...
            '· ลำดับ: ก. ปิดรูรั่วหน้าเว็บ (หลักชั่วโมง) → ข. หลังบ้านรับ lead (2.5 วัน) → '
            'ค. ซ่อนเมนูกองที่ 2 → ง. ที่เหลือรอจนมีดีลจริง '
            '· ยังค้างรอเจ้าของ: RM-3 · QF-1 และ QF-2 (ข้อเสนอปิดมติอยู่ที่ '
            '`docs/queueflow_salepage_structure.md` แล้ว รอเคาะ) · PY-1',
}
...
PHASES = [
    ...
    },
    {
        ...
        'items': [
            ...
            {'name': 'ต่อฟอร์ม lead หน้า QueueFlow เข้า ContactLead + honeypot', 'status': TODO,
            ...
            # --- ง. รอจนมีดีลจริงค่อยทำ จะได้ออกแบบจากงานจริงไม่ใช่จินตนาการ ---
            {'name': 'สะพาน Lead -> Customer ปุ่มเดียว + ผูก AIProject กับ Customer', 'status': TODO,
             'note': 'รอมีดีลจริงก่อน · ตอนนี้ปิดดีลแรกต้องพิมพ์ข้อมูลซ้ำ 4 รอบ '
                     'และงานที่ส่งมอบแล้ว 6 ตัวไม่มีเจ้าของ'},
            {'name': 'Quote: items/subtotal/total + พิมพ์ PDF + ปุ่ม Quote -> Invoice', 'status': TODO,
             'note': 'รอมีดีลจริงก่อน · ไม่มีอันนี้ Quote Builder คือเมนูหลอก '
                     'และเอกสารทุกใบต้องทำนอกระบบ'},
            {'name': 'ที่เก็บ Partner/Referral + ค่าคอม 10-15%', 'status': TODO,
             'note': 'รอมีดีลจริงก่อน · GTM ตั้ง KPI referral 30% ของลูกค้าใหม่ '
                     'แต่ยังไม่มีที่บันทึกแม้แต่ช่องเดียว'},
        ],
    },
]
