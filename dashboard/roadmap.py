...
PHASES = [
    ...
    },
    {
        ...
        'items': [
            ...
            {'name': 'marketing/playbook.py + หน้า /owner/playbook/', 'status': TODO,
             'note': '**เจ้าของทักท้วง 27 ส.ค. 69 ว่าแผนพัฒนากับแผนการตลาดถูกยัดรวมกัน** '
                     '· ไฟล์นี้เป็นแผนของโค้ด — งานมีวัน DONE แล้วจบ '
                     'แต่งานการตลาดคือพฤติกรรมที่ทำซ้ำทุกสัปดาห์ ไม่มีวันจบ '
                     'เอามาปนกันแล้วเปอร์เซ็นต์ความคืบหน้าจะโกหก '
                     '· playbook.py จึงเป็นแผนรายสัปดาห์ วัด "ทำไปกี่ครั้ง / ได้ lead กี่ราย" '
                     'เทียบกับเป้า ไม่ใช่เสร็จ/ไม่เสร็จ '
                     '· ของที่ต้องย้ายมาอยู่ที่นี่: ทักร้าน 20 ราย/สัปดาห์ · โพสต์ FB Group · '
                     'บทความ SEO · ตามงาน lead ค้าง · ขอ testimonial จาก Bergen · '
                     'ลง Expense ทุกรายการ (ย้ายออกจากเฟส 9 แล้ว) '
                     '· ที่มาของเนื้อหา: docs/gtm_strategy.html และ docs/action_plan.html '
                     'ซึ่งเขียนไว้ตั้งแต่ พ.ค. 69 แต่เป็นเอกสารตาย ไม่มีสถานะ '
                     'ผลคือ 8 ช่องทางใน GTM ทำจริง 0 ช่องทาง '
                     '· ใช้โครง settings-hero + scard เหมือนหน้า /owner/ อื่น'},
