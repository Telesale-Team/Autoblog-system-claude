...
```
[Topic Idea] → SEO Research → Content Brief → Outline → Draft
   → QA → On-page SEO → Publish → Track → Iterate
```
...
- หา **cover image** จาก Unsplash + ใส่ใน frontmatter
